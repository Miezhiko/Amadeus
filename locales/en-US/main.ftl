...
user-commands = • **score** *<@user>*: show *user* points
  ...
  • *gif commands:* cry, hug, pat, slap, cringe, wave, sex, ahegao, clap, shrug, lol, angry, dance, confused, shock, nervous, sad, happy, annoyed, omg, smile, ew, awkward, oops, lazy, hungry, stressed, scared, bored, yes, no, bye, sorry, sleepy, wink, facepalm, whatever, pout, smug, smirk
...
warcraft-commands-title = warcraft 3 commands
